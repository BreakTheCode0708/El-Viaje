...
<section class="home" id="home">
    <div class="content">
        <h3 style="color: rgba(234, 226, 126, 0.979)">Hotels</h3>
    </div>
    <div class="video-container">
        <video src="images/Hotel - 3525.mp4" id="video-slider" loop autoplay muted></video>
    </div>
</section> 
<section>
    <div class="form-style-10">
        ...
        <form method="POST" onsubmit="hotels.php">

        <div class="section" style="padding-bottom: 20px;"><span>1</span>Select Your Trip Location</div>
...
<!-- <div class="box">
    ...
    <a href="attraction_etl.html">We help you find the best hotels for your stay according to your preferences.</a>
</div> -->
<div class="table">
